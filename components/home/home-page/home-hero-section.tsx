  ...
  return (
    <section className="min-h-svh grid grid-cols-1 place-items-center text-center px-6 sm:px-8 py-20 relative overflow-hidden">
      ...
      <div className={styles.heroDeco} aria-hidden="true">
        <div
          className={`${styles.decoLine} ${styles.decoH}`}
          style={{ top: "20%" }}
        />
        <div
          className={`${styles.decoLine} ${styles.decoH}`}
        ...
        />
        <div
          className={`${styles.decoLine} ${styles.decoV}`}
          style={{ left: "10%" }}
        />
        <div
          className={`${styles.decoLine} ${styles.decoV}`}
      ...
      <div className="w-full max-w-[640px] min-w-0 relative z-[1]">
        <p
        ...
        <h1
          className="text-[clamp(2.45rem,10vw,8rem)] font-bold leading-none tracking-tight text-paper-50 break-words"
