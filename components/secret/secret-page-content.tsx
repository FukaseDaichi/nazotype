...
import { SecretShareAvailabilityProvider } from "@/components/secret/secret-share-availability-context";
import { SecretSharePanel } from "@/components/secret/secret-share-panel";
...
export function SecretPageContent({
  ...
  return (
    <SecretShareAvailabilityProvider>
