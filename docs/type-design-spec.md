...
| --- | --- |
| `ALHN` | 行動型 / 局所型 / 発信型 / 熟考型 |
| `ALHC` | 行動型 / 局所型 / 発信型 / 転換型 |
| `ALTN` | 行動型 / 局所型 / 統率型 / 熟考型 |
| `ALTC` | 行動型 / 局所型 / 統率型 / 転換型 |
| `ABHN` | 行動型 / 俯瞰型 / 発信型 / 熟考型 |
| `ABHC` | 行動型 / 俯瞰型 / 発信型 / 転換型 |
| `ABTN` | 行動型 / 俯瞰型 / 統率型 / 熟考型 |
| `ABTC` | 行動型 / 俯瞰型 / 統率型 / 転換型 |
| `DLHN` | 解読型 / 局所型 / 発信型 / 熟考型 |
| `DLHC` | 解読型 / 局所型 / 発信型 / 転換型 |
| `DLTN` | 解読型 / 局所型 / 統率型 / 熟考型 |
| `DLTC` | 解読型 / 局所型 / 統率型 / 転換型 |
| `DBHN` | 解読型 / 俯瞰型 / 発信型 / 熟考型 |
| `DBHC` | 解読型 / 俯瞰型 / 発信型 / 転換型 |
| `DBTN` | 解読型 / 俯瞰型 / 統率型 / 熟考型 |
| `DBTC` | 解読型 / 俯瞰型 / 統率型 / 転換型 |

※ 各タイプのタイプ名・タグライン等の定義は未策定。
