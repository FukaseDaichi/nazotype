...
診断完了件数とタイプ別割合は GA4 だけで集計する。

- 送信 event: `diagnosis_complete`
- 送信 parameter: `type_code`
- 送信箇所: `components/diagnosis/diagnosis-flow/diagnosis-flow.tsx` の診断完了処理
- script 読み込み予定箇所: `app/layout.tsx`
- helper 追加予定箇所: `lib/analytics.ts`
- 詳細: [survey-result-statistics-architecture.md](./survey-result-statistics-architecture.md)
